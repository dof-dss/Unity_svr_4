 ...
 * {@inheritdoc}
 */
class storiesBreadcrumb implements BreadcrumbBuilderInterface {
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    if ($this->node) {
      ...
      $links[] = Link::fromTextandUrl(t('Stories'), Url::fromUri('internal:/stories'));
